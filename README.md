...
| `/welcome-channel` | ตั้งค่าช่องที่จะส่งการ์ดต้อนรับและบอกลาสมาชิกใหม่ |
| `/welcome-set-message` | ตั้งค่าข้อความต้อนรับ/บอกลาแบบข้อความธรรมดา (ไม่ใช้ Embed) |
| `/welcome-set-embed` | ตั้งค่าการ์ด Embed ต้อนรับ/บอกลาแบบกำหนดเอง (รองรับสี, รูปภาพ, และ GIF) |
| `/welcome-test` | จำลองส่งการ์ดต้อนรับและบอกลาเพื่อตรวจสอบรูปแบบ |
| `/welcome-disable` | ปิดใช้งานและลบข้อมูลต้อนรับ/บอกลาสมาชิกใหม่ทั้งหมดของเซิร์ฟเวอร์ |
